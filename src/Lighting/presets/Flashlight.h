...
const Types::SpotLight FLASHLIGHT{FLASHLIGHT_POSITION, FLASHLIGHT_DIRECTION, FLASHLIGHT_AMBIENT,   FLASHLIGHT_DIFFUSE, FLASHLIGHT_SPECULAR,
                                  FLASHLIGHT_CONSTANT, FLASHLIGHT_LINEAR,    FLASHLIGHT_QUADRATIC, FLASHLIGHT_CUT_OFF, FLASHLIGHT_OUTER_CUT_OFF};
